/**
 * This file is copied from YUI example and 80x86 modified it for the Tank project.
 * @author YUI, 80x86
 */
/**
 ...
 * @param nodeId   {integer} The id of the node in the db; author: 80x86
 */
YAHOO.widget.TaskNode = function(oData, oParent, expanded, checked, nodeId, isFolder) {
...
YAHOO.extend(YAHOO.widget.TaskNode, YAHOO.widget.TextNode, {
	...
	setIsFolder: function(bl) {
		this.folder = bl;
		if (!bl) {
	        this.dynamicLoadComplete = true;
	        this.isLoading = false;
	        this.tree.locked = false;
	        // set icon to leaf, good!
	        this.iconMode = 1;
		}
	},
    ...
    /**
     * set up the id of the node
     */
    setUpTreeNodeId: function(nodeId) {
    ...
    getNodeHtml: function() { 
        ...
        if (this.hasChildren(this.isFolder())) {
