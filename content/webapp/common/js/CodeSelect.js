...
function code_CodeSelect(field, codeType, codeRelation, isClear, otherCondition, typeParam, varParamField, callBackMethod, getDataMethod) {
    ...
    inCodeQuery = true; 
    if(codeType == "exceptCenterCode"||codeType=="expertUser"){
    	var permitCenterCode = document.getElementById("epsPayWay.permitCenterCode").value;
    	otherCondition = permitCenterCode;
    }
