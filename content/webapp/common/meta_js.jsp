...
<script language="javascript" src="${ctx}/widgets/yui/tabview/tabview.js"></script>
<script language="javascript" src="${ctx}/widgets/yui/yuiloader/yuiloader-min.js"></script>
<script language="javascript" src="${ctx}/widgets/datatable_init.js"></script>
<script type="text/javascript" src="${ctx}/widgets/yui/yuiloader/yuiloader-min.js"></script>
<script type="text/javascript" src="${ctx}/widgets/yui/event/event-min.js"></script>
<script type="text/javascript" src="${ctx}/widgets/yui/dom/dom-min.js"></script>
<script type="text/javascript" src="${ctx}/widgets/yui/logger/logger-min.js"></script>
<script type="text/javascript" src="${ctx}/widgets/yui/treeview/treeview-debug.js"></script>
<script type="text/javascript" src="${ctx}/widgets/yui/element/element-min.js"></script>
<script type="text/javascript" src="${ctx}/widgets/yui/button/button-min.js"></script>
