		    ...
		    var oId = oRecord.userCode;
		     if(oColumn.key=="gradeEdit"){
		      ...
		      if(oColumn.key=="powerEdit"){
	    		  elCell.innerHTML = "<a href=\"#\" onclick=\"editRecord('${ctx}/saaUserGrade/prepareUpdateAgentUserGradePower.do?userCode=" + oId+"')\"><s:text name='userinstead.config'/></a>";
		      }
		      if(oColumn.key=="powerGrantEdit"){
	    		  elCell.innerHTML = "<a href=\"#\" onclick=\"editRecord('${ctx}/saaUserPower/prepareUpdateAgentUserGradePower.do?userCode=" + oId+"')\"><s:text name='userinstead.config'/></a>";
		      }
