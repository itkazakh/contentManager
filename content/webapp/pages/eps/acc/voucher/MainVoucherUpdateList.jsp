...
<html>
	...
	<body id="all_title">
		<div id="wrapper">
			<div id="crash_menu">
				<h2 align="center">
					<s:text name="applyMain.head" />
				</h2>
			</div>
			<s:form action="queryVoucher" method="post" namespace="/mainVoucher"
				name="fm" validate="true" onsubmit="return submitQuery(this)">
				<table class="fix_table" border="0">
					<tr>
						...
						<td class="long">
							<s:textfield name="epsMainVoucher.yearMonth"
								requiredposition="right" cssClass='input_w w_15' />
						</td>
						<td class="bgc_tt short">
							<s:text name="epsMainVoucher.operatorCode" />
						</td>
						<td class="long">
							<s:textfield name="epsMainVoucher.operatorCode"
								requiredposition="right" cssClass='input_w w_15' />
						</td>
					</tr>
					<tr>
						...
						<td class="long">
							<s:textfield name="fromId" requiredposition="right"
						...
						<td class="long">
							<s:textfield name="toId" requiredposition="right"
								cssClass='input_w w_15' />
						</td>
					</tr>
					<tr>
						...
						<td colspan="2" align="center">
							<input type="reset" id="addButton"
								value="<s:text name="common.reset" />" class="button_ty">
						</td>
					</tr>
				</table>
			</s:form>
...
YAHOO.widget.Column.formatEmail = function(elCell, oRecord, oColumn, oData) { 
	...
	YAHOO.widget.Column.formatLink = function(elCell, oRecord, oColumn, oData) { 
	  ...
	  elCell.innerHTML = "<a href=\"#\" onclick=\"showRecord('./viewMainVoucherUpdate.do?id=" + oId + "')\">"+oData+"</a>";
	    }else{
...
function executeQuery(pageNo,pageSize){ 
   ...
   var initialRequest = "pageSize="+pageSize+"&pageNo="+pageNo; 	
	...
	var myDataSource = new YAHOO.util.DataSource("./queryVoucher.do");
