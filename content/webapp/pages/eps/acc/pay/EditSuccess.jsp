...
<table class=common align=center>
	...
	<tr>
		...
		<td class="common"> <s:property value="%{businessNo}"/><s:text name='success.ok' />!<s:text name='acc.payNo' />：<s:property value="%{payRefNo}"/></td>
	</tr>
	<tr>
	<td><input type="button" class="button_ty" value="<s:text name='common.ok' />" onclick="closePages();"/></td>
	</tr>	
</table>
</body>
<%@ include file="/common/meta_js.jsp"%>
	<script type="text/javascript">
	function closePages(){
	parent.window.opener.executeQuery(1,10);
		try{
