...
<script type="text/javascript">
	...
	function init(){
		...
		var comCode_tip = new YAHOO.widget.Tooltip("comCode_tip",{text:'<s:text name="userinstead.doubleclickcomcode"/>',context:"saaUser.comCode",zIndex:300});	
		 YAHOO.widget.Column.formatLink = function(elCell, oRecord, oColumn, oData) { 
		    var oId = oRecord.userCode;
		     if(oColumn.key=="edit"){
	    		 elCell.innerHTML = "<a href=\"#\" onclick=\"editRecord('${ctx}/saaUserInstead/checkUserInstead.do?userCode=" + oId+"')\"><s:text name='userinstead.config'/></a>";
		      }
		...
		contentColumnHeaders =[
			...
			{key:"edit",text:'<s:text name="userinstead.toauthorize"/>',width:"20em",type:"link",resizeable:true}
			]; 
	}
	//Query Data
